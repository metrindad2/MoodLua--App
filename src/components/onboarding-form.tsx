...
export default function OnboardingForm() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-dvh p-4 text-white">
      <div className="flex flex-col items-center justify-center text-center mb-6">
        <Image src="/logo.png" alt="MoodLua Logo" width={64} height={64} className="mb-2" />
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <Input type="text" placeholder="Seu nome" {...field} className="bg-white/20 border-none placeholder:text-white/70" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <div className="grid grid-cols-2 gap-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-white/80 text-xs pl-1">Ciclo (dias)</FormLabel>
                    <FormControl>
                      <Input type="number" {...field} className="bg-white/20 border-none placeholder:text-white/70" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-white/80 text-xs pl-1">Período (dias)</FormLabel>
                    <FormControl>
                      <Input type="number" {...field} className="bg-white/20 border-none placeholder:text-white/70" />
                    </FormControl>
                    <FormMessage />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <Input type="email" placeholder="Email" {...field} className="bg-white/20 border-none placeholder:text-white/70" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <Input type="password" placeholder="Senha" {...field} className="bg-white/20 border-none placeholder:text-white/70" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <Button type="submit" className="w-full bg-white/30 hover:bg-white/40 text-white font-bold text-base py-6">
              Criar conta
            </Button>
          </form>
        </Form>
