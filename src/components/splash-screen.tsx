...
export function SplashScreen() {
  return (
    <div className="relative flex h-dvh w-full flex-col items-center justify-center overflow-hidden bg-gradient-to-b from-purple-900 to-purple-600 text-white">
      {/* Stars with will-change for smoother animations */}
      ...
      <div className="relative flex flex-col items-center justify-center text-center">
        <div className="relative mb-8 flex items-center justify-center animate-moon-reveal opacity-0 will-change-transform" style={{ animationDelay: '0.1s' }}>
          <div className="absolute h-48 w-48">
            <div className="absolute top-1 left-1/2 -ml-2.5 h-5 w-5 rounded-full bg-purple-300 shadow-lg animate-twinkle" style={{ animationDelay: '0.2s' }} />
          </div>
        ...
        <div>
          <h1 className="font-cursive text-7xl text-white opacity-0 drop-shadow-lg animate-text-reveal will-change-transform" style={{ animationDelay: '0.3s' }}>
            MoodLua
          </h1>
          <p className="mt-2 text-lg text-white/80 opacity-0 animate-slogan-fade will-change-opacity" style={{ animationDelay: '0.5s' }}>
